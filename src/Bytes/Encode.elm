...
string str =
    Utf8 (Native.Bytes.getStringWidth str) str
...
write builder mb offset =
    case builder of
        I8 n ->
            Native.Bytes.write_i8 mb offset n

        I16 e n ->
            Native.Bytes.write_i16 mb offset n (e == LE)

        I32 e n ->
            Native.Bytes.write_i32 mb offset n (e == LE)

        U8 n ->
            Native.Bytes.write_u8 mb offset n

        U16 e n ->
            Native.Bytes.write_u16 mb offset n (e == LE)

        U32 e n ->
            Native.Bytes.write_u32 mb offset n (e == LE)

        F32 e n ->
            Native.Bytes.write_f32 mb offset n (e == LE)

        F64 e n ->
            Native.Bytes.write_f64 mb offset n (e == LE)

        Seq _ bs ->
            writeSequence bs mb offset

        Utf8 _ s ->
            Native.Bytes.write_string mb offset s

        Bytes bs ->
            Native.Bytes.write_bytes mb offset bs
